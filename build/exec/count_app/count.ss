...
(define Main-n--3716-5744-u--wordCount (lambda (arg-0 arg-1) (PreludeC-45TypesC-45List-lengthTR (DataC-45String-words arg-1))))
...
(define Main-n--3716-5743-u--allLengths (lambda (arg-0 arg-1) (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (PreludeC-45TypesC-45String-length eta-0)) arg-1)))
...
(define Main-showAverage (lambda (arg-0) (string-append "The average word length is : " (string-append (PreludeC-45Show-u--show_Show_Double (Main-average arg-0)) "\xa;"))))
